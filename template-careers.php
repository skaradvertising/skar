...
<div class="container-fluid careers-container">
	<section class="row row-eq-height careers-section">
		...
		<div class="col-lg-8 col-md-8 col-sm-7 careers-content-wrapper">
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 careers-label">
				<?php the_title('<h3>', '</h3>'); ?>
			</div>
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 careers-content">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 careers-contact">
